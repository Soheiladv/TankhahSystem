...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action_type', models.CharField(choices=[('DRAFT', 'پیش\u200cنویس'), ('PENDING', 'در حال بررسی'), ('APPROVE', 'تأیید شده'), ('REJECT', 'رد شده'), ('STAGE_CHANGE', 'تغییر مرحله'), ('DELETE', 'حذف'), ('CREATE', 'ایجاد'), ('EDIT', 'ویرایش'), ('VIEW', 'مشاهده'), ('PAID', 'پرداخت شده'), ('PARTIAL', 'تأیید جزئی'), ('PENDING_APPROVAL', 'در انتظار تأیید'), ('APPROVED_INTERMEDIATE', 'تأیید میانی'), ('APPROVED_FINAL', 'تأیید نهایی'), ('SIGN_PAYMENT', 'امضای دستور پرداخت'), ('SENT_TO_HQ', 'ارسال\u200cشده به HQ'), ('HQ_OPS_PENDING', 'در حال بررسی - بهره\u200cبرداری'), ('HQ_OPS_APPROVED', 'تأییدشده - بهره\u200cبرداری'), ('HQ_FIN_PENDING', 'در حال بررسی - مالی')], max_length=50, verbose_name='نوع اقدام')),

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('factor_payment_ceiling_default', models.DecimalField(blank=True, decimal_places=2, max_digits=25, null=True, verbose_name='سقف پرداخت پیش\u200cفرض فاکتور')),
                ('factor_payment_ceiling_enabled_default', models.BooleanField(default=False, verbose_name='فعال بودن پیش\u200cفرض سقف پرداخت فاکتور')),
                ('allow_tankhah_budget_overrun', models.BooleanField(default=False, help_text='اگر فعال باشد، در هنگام ثبت تنخواه/فاکتور، امکان ثبت مبلغ بیش از مانده تنخواه مجاز است.', verbose_name='اجازه ثبت بیش از بودجه تنخواه')),
                ('allow_factor_budget_overrun', models.BooleanField(default=False, help_text='اگر فعال باشد، امکان ثبت مبلغ فاکتور بیش از مانده تنخواه مجاز است (مستقل از تنخواه).', verbose_name='اجازه ثبت بیش از بودجه فاکتور')),
                ('lock_period_after_expiry_enforce_on_write_only', models.BooleanField(default=True, help_text='اگر فعال باشد، انقضای دوره باعث قفل سراسری نمی\u200cشود و فقط هنگام اقداماتی مثل ثبت تنخواه/تخصیص اعمال می\u200cگردد.', verbose_name='قفل دوره پس از انقضا فقط حین ثبت')),
                ('exclude_expired_tankhah_from_factor_form', models.BooleanField(default=True, help_text='اگر فعال باشد، تنخواه\u200cهایی که due_date آن\u200cها گذشته است از dropdown فرم ایجاد فاکتور حذف می\u200cشوند.', verbose_name='حذف تنخواه\u200cهای منقضی\u200cشده از لیست فاکتور')),
                ('enforce_tankhah_ceiling_on_factor', models.BooleanField(default=True, help_text='اگر فعال باشد، هنگام ثبت فاکتور، چک می\u200cشود که مبلغ فاکتور از سقف تنخواه تجاوز نکند.', verbose_name='اجبار سقف مبلغ در فرم فاکتور')),
                ('create_budget_commitment_on_factor_draft', models.BooleanField(default=True, help_text='اگر فعال باشد، هنگام ثبت فاکتور، یک COMMITMENT در BudgetTransaction ایجاد می\u200cشود و بودجه رزرو می\u200cشود.', verbose_name='ایجاد تعهد بودجه هنگام ثبت فاکتور')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sub_organizations', to='core.organization', verbose_name='سازمان والد'),
        ),
        migrations.CreateModel(
            name='FontSettings',
            fields=[
            ...
            options={
                ...
                'permissions': [('FontSettingsـadd', 'افزودن تنظیمات فونت '), ('FontSettingsـview', 'نمایش تنظیمات فونت '), ('FontSettingsـupdate', 'بروزرسانی تنظیمات فونت '), ('FontSettingsـdelete', 'حذف تنظیمات فونت ')],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'default_permissions': (),
                'indexes': [models.Index(fields=['entity_type', 'organization', 'from_status', 'is_active'], name='core_transi_entity__5109ac_idx')],
            },
        ),
        migrations.AddIndex(
            model_name='status',

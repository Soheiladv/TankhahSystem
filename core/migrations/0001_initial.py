...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200, verbose_name='نام تمپلیت')),
                ('description', models.TextField(blank=True, verbose_name='توضیحات')),
                ('entity_type', models.CharField(choices=[('FACTOR', 'فاکتور'), ('TANKHAH', 'تنخواه'), ('PAYMENTORDER', 'دستور پرداخت'), ('BUDGET_ALLOCATION', 'تخصیص بودجه')], max_length=50, verbose_name='نوع موجودیت')),
                ('rules_data', models.JSONField(verbose_name='داده\u200cهای قوانین')),
                ('is_active', models.BooleanField(default=True, verbose_name='فعال')),
                ('is_public', models.BooleanField(default=False, verbose_name='عمومی (قابل استفاده برای همه)')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='تاریخ ایجاد')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='تاریخ به\u200cروزرسانی')),
            ...
            options={
                'verbose_name': 'تمپلیت قانون گردش کار',
                'verbose_name_plural': 'تمپلیت\u200cهای قوانین گردش کار',
                'permissions': [('WorkflowRuleTemplate_add', 'افزودن تمپلیت قانون گردش کار'), ('WorkflowRuleTemplate_view', 'نمایش تمپلیت قانون گردش کار'), ('WorkflowRuleTemplate_update', 'ویرایش تمپلیت قانون گردش کار'), ('WorkflowRuleTemplate_delete', 'حذف تمپلیت قانون گردش کار')],
                'default_permissions': (),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.organization', verbose_name='سازمان')),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.post', verbose_name='پست')),
                ('rule_template', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.workflowruletemplate', verbose_name='تمپلیت قانون')),
            ],
            options={

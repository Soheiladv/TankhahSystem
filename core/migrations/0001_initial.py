    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entity_type', models.CharField(choices=[('TANKHAH', 'تنخواه'), ('FACTOR', 'فاکتور'), ('PAYMENTORDER', 'دستور پرداخت')], max_length=20, verbose_name='نوع موجودیت')),
                ('is_active', models.BooleanField(default=True, verbose_name='فعال')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.CharField(blank=True, choices=[('CEO', 'مدیرعامل'), ('FIN', 'مالی و اداری'), ('INV', 'سرمایه\u200cگذاری'), ('HOT', 'هتل\u200cها'), ('STF', 'دیگر واحدهای ستادی'), (None, 'بدون شاخه')], max_length=3, null=True, verbose_name='شاخه')),
                ('description', models.TextField(blank=True, null=True, verbose_name='توضیحات')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('branch', models.CharField(blank=True, choices=[('CEO', 'مدیرعامل'), ('FIN', 'مالی و اداری'), ('INV', 'سرمایه\u200cگذاری'), ('HOT', 'هتل\u200cها'), ('STF', 'دیگر واحدهای ستادی'), (None, 'بدون شاخه')], max_length=3, verbose_name='شاخه')),
                ('action_type', models.CharField(choices=[('APPROVE', 'تأیید'), ('REJECT', 'رد'), ('VIEW', 'مشاهده'), ('SIGN_PAYMENT', 'امضای دستور پرداخت'), ('STATUS_CHANGE', 'تغییروضعیت')], max_length=25, verbose_name='نوع اقدام')),
                ('entity_type', models.CharField(choices=[('FACTOR', 'فاکتور'), ('TANKHAH', 'تنخواه'), ('BUDGET', 'بودجه'), ('PAYMENTORDER', 'دستور پرداخت'), ('REPORTS', 'گزارشات'), ('GENERAL', 'عمومی')], max_length=100, verbose_name='نوع موجودیت')),
                ('is_active', models.BooleanField(default=True, verbose_name='فعال')),

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entity_type', models.CharField(choices=[('FACTOR', 'فاکتور'), ('FACTORITEM', 'ردیف فاکتور'), ('TANKHAH', 'تنخواه'), ('BUDGET', 'بودجه'), ('PAYMENTORDER', 'دستور پرداخت'), ('REPORTS', 'گزارشات'), ('GENERAL', 'عمومی')], max_length=50, verbose_name='برای نوع موجودیت')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='تاریخ ایجاد')),
                ('is_active', models.BooleanField(db_index=True, default=True, verbose_name='فعال')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='تاریخ ایجاد')),
                ('is_active', models.BooleanField(db_index=True, default=True, verbose_name='فعال')),
                ('allowed_actions', models.ManyToManyField(to='core.action', verbose_name='اقدامات مجاز')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='ایجادکننده')),
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.organization', verbose_name='سازمان')),
                ('allowed_posts', models.ManyToManyField(to='core.post', verbose_name='پست\u200cهای مجاز')),
                ('on_status', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.status', verbose_name='در وضعیت')),
                ('transition', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.transition', verbose_name='برای گذار')),
            ],
            options={
                'verbose_name': 'مجوز گردش کار',
                'verbose_name_plural': '۴. مجوزهای گردش کار',
                'permissions': [('Permission_add', ' افزودن مجوز گردش کار '), ('Permission_update', '  ویرایش مجوز گردش کار '), ('Permission_view', '  نمایش مجوز گردش کار '), ('Permission_delete', '  حــذف مجوز گردش کار ')],
                'default_permissions': (),
            },
        ),
        migrations.CreateModel(

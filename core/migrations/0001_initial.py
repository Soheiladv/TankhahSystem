# Generated by Django 5.1.7 on 2025-07-01 04:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_type', models.CharField(choices=[('APPROVE', 'تأیید'), ('REJECT', 'رد'), ('VIEW', 'مشاهده'), ('SIGN_PAYMENT', 'امضای دستور پرداخت')], max_length=25, verbose_name='نوع اقدام')),
                ('entity_type', models.CharField(choices=[('FACTOR', 'فاکتور'), ('TANKHAH', 'تنخواه'), ('BUDGET', 'بودجه'), ('PAYMENTORDER', 'دستور پرداخت'), ('REPORTS', 'گزارشات')], max_length=100, verbose_name='نوع موجودیت')),
                ('is_active', models.BooleanField(default=True, verbose_name='فعال')),

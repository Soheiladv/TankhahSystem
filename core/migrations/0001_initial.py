...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action_type', models.CharField(choices=[('APPROVE', 'تأیید'), ('REJECT', 'رد'), ('FINALIZE', 'اتمام'), ('CUSTOM', 'سفارشی')], max_length=50, verbose_name='نوع اقدام')),
                ('entity_type', models.CharField(choices=[('TANKHAH', 'تنخواه'), ('BUDGET_ALLOCATION', 'تخصیص بودجه'), ('BUDGET_RETURN', 'تخصیص بودجه'), ('ISSUE_PAYMENT_ORDER', 'صدور دستور پرداخت')], default='TANKHAH', max_length=50, verbose_name='نوع موجودیت')),
                ('is_active', models.BooleanField(default=True, verbose_name='فعال')),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.post', verbose_name='پست')),

...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('number', models.CharField(blank=True, max_length=20, verbose_name='شماره فاکتور')),
                ...
                ('approved_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='تأییدکننده')),
            ],
            options={
                'verbose_name': 'فاکتور',
                'verbose_name_plural': 'فاکتورها',
                'permissions': [('Factor_add', 'افزودن فاکتور برای جزئیات تنخواه '), ('Factor_update', 'ویرایش فاکتور برای جزئیات تنخواه'), ('Factor_delete', 'حــذف فاکتور برای جزئیات تنخواه'), ('Factor_view', 'نمایش فاکتور برای جزئیات تنخواه')],
                'default_permissions': (),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('factor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='documents', to='tanbakh.factor', verbose_name='فاکتور')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': [('StageApprover_view', 'نمایش تأییدکننده مرحله'), ('StageApprover_add', 'افزودن تأییدکننده مرحله'), ('StageApprover_Update', 'بروزرسانی تأییدکننده مرحله'), ('StageApprover_delete', 'حــذف تأییدکننده مرحله')],
                'default_permissions': (),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_stage', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.workflowstage', verbose_name='مرحله فعلی')),
        ...
        migrations.AddField(
            model_name='factor',
            name='tanbakh',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='factors', to='tanbakh.tanbakh', verbose_name='تنخواه'),
        ),
        migrations.CreateModel(
            name='ApprovalLog',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(choices=[('APPROVE', 'تأیید'), ('REJECT', 'رد'), ('EDIT', 'ویرایش')], max_length=10, verbose_name='اقدام')),
                ...
                ('factor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='approval_logs', to='tanbakh.factor', verbose_name='فاکتور')),
                ('factor_item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='approval_logs', to='tanbakh.factoritem', verbose_name='ردیف فاکتور')),
                ('tanbakh', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='approval_logs', to='tanbakh.tanbakh', verbose_name='تنخواه')),
            ],
            options={
                'verbose_name': 'تأیید',

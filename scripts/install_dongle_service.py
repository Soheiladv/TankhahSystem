#!/usr/bin/env python
"""
نصب Windows Service برای USB Dongle
...
def install_dongle_service():
    """نصب Windows Service برای USB Dongle"""
    print("🔧 نصب Windows Service برای USB Dongle...")
    print("=" * 60)
...
'''
    ...
    ps_path = os.path.join(project_path, "scripts", "install_dongle_service.ps1")
...
'''
    ...
    print(f"")
    print(f"2. برای نصب Windows Service:")
    print(f"   - راست کلیک روی: scripts/install_dongle_service.ps1")
...
def main():
    """تابع اصلی"""
    print("🔐 نصب سیستم USB Dongle با دسترسی ادمین")
    print("=" * 60)
    
    if install_dongle_service():
        print(f"\n✅ همه اسکریپت‌ها با موفقیت ایجاد شدند!")
        print(f"\n🚀 حالا می‌توانید:")
        print(f"1. دوبار کلیک روی: scripts/run_django_admin_auto.vbs")
        print(f"2. در پنجره UAC که باز می‌شود 'Yes' را کلیک کنید")
        print(f"3. Django با دسترسی ادمین شروع می‌شود")
        print(f"4. برو به: http://127.0.0.1:8000/usb-key-validator/enhanced/")
        print(f"5. dongle را ایجاد کن")
    else:

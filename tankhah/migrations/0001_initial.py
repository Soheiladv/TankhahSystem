    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, verbose_name='توضیحات')),
                ('status', models.CharField(choices=[('DRAFT', 'پیش\u200cنویس'), ('PENDING_APPROVAL', 'در انتظار تأیید'), ('APPROVED_INTERMEDIATE', 'تأیید میانی'), ('APPROVED_FINAL', 'تأیید نهایی'), ('REJECT', 'رد شده'), ('PAID', 'پرداخت شده'), ('PARTIAL', 'تأیید جزئی')], default='PENDING_APPROVAL', max_length=40, verbose_name='وضعیت')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_stage', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.accessrule', verbose_name='مرحله فعلی گردش کار')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(choices=[('APPROVE', 'تأیید'), ('REJECT', 'رد'), ('SUBMIT', 'ارسال برای تایید'), ('FINAL_APPROVE', 'تایید نهایی'), ('VIEW', 'مشاهده'), ('EDIT', 'ویرایش'), ('CREATE', 'ایجاد'), ('DELETE', 'حذف'), ('SIGN_PAYMENT', 'امضای دستور پرداخت')], max_length=45, verbose_name='نوع اقدام')),
                ...
                ('stage_rule', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='approval_logs', to='core.accessrule', verbose_name='قانون/مرحله مرتبط')),

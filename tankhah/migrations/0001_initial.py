...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('object_id', models.PositiveIntegerField(blank=True, null=True, verbose_name='شناسه موجودیت')),
                ...
                ('is_final_approval', models.BooleanField(default=False, verbose_name='نهایی شده')),
                ...
                ('action', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.action', verbose_name='نوع اقدام گردش کار')),
                ('content_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype', verbose_name='نوع موجودیت')),
                ('from_status', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='+', to='core.status')),
                ('post', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.post', verbose_name='پست تأییدکننده')),
                ('stage', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='approval_logs_access', to='core.status', verbose_name='وضعیت')),
                ('stage_rule', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='approval_logs', to='core.status', verbose_name='وضعیت مرتبط')),
                ('to_status', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='+', to='core.status')),
            ...
            options={
                'verbose_name': 'لاگ\u200cهای تأیید👍/رد👎',
                'verbose_name_plural': 'لاگ\u200cهای تأیید👍/رد👎',
                'ordering': ['-timestamp'],
                'permissions': [('Approval_add', 'افزودن تأیید برای ثبت اقدامات تأیید یا رد'), ('Approval_update', 'ویرایش تأیید برای ثبت اقدامات تأیید یا رد'), ('Approval_delete', 'حــذف تأیید برای ثبت اقدامات تأیید یا رد'), ('Approval_view', 'نمایش تأیید برای ثبت اقدامات تأیید یا رد'), ('Stepchange', 'تغییر مرحله')],
                'default_permissions': (),
            },
        ),
        migrations.CreateModel(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['factor', 'tankhah', 'user', 'stage', 'action'], name='tankhah_app_factor__78b8dd_idx'),
        ),
    ]

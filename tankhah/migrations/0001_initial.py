# Generated by Django 5.1.7 on 2025-07-24 19:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': [('factor_add', 'افزودن فاکتور'), ('factor_view', 'نمایش فاکتور'), ('factor_update', 'بروزرسانی فاکتور'), ('factor_delete', 'حذف فاکتور'), ('factor_approve', ' 👍تایید/رد ردیف فاکتور (تایید ردیف فاکتور*استفاده در مراحل تایید*)'), ('factor_reject', 'رد فاکتور'), ('Factor_full_edit', 'دسترسی کامل به فاکتور'), ('factor_unlock', 'باز کردن فاکتور قفل\u200cشده')],
                'default_permissions': (),
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stage', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='approval_logs_access', to='core.accessrule', verbose_name='مرحله')),

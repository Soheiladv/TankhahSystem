...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='tankhah',
            index=models.Index(fields=['number', 'date', 'status', 'organization', 'project', 'created_at'], name='tankhah_tan_number_ddd2e8_idx'),
        ),
        migrations.AddIndex(
            model_name='factor',
            index=models.Index(fields=['number', 'is_deleted', 'date', 'status', 'tankhah', 'is_archived'], name='tankhah_fac_number_47501a_idx'),
        ),
        migrations.AddIndex(

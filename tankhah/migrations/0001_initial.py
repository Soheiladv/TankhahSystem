    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payee', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='budgets.payee', verbose_name='صادرکننده فاکتور')),
                ('purchase_request', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='factors', to='purchase_requests.purchaserequest', verbose_name='درخواست کالا')),

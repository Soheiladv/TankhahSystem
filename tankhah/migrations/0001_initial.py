    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, verbose_name='توضیحات')),
                ('status', models.CharField(choices=[('DRAFT', 'پیش\u200cنویس'), ('PENDING', 'در حال بررسی'), ('APPROVE', 'تأیید شده'), ('REJECT', 'رد شده'), ('STAGE_CHANGE', 'تغییر مرحله'), ('DELETE', 'حذف'), ('CREATE', 'ایجاد'), ('EDIT', 'ویرایش'), ('VIEW', 'مشاهده'), ('PAID', 'پرداخت شده'), ('PARTIAL', 'تأیید جزئی'), ('PENDING_APPROVAL', 'در انتظار تأیید'), ('APPROVED_INTERMEDIATE', 'تأیید میانی'), ('APPROVED_FINAL', 'تأیید نهایی'), ('SIGN_PAYMENT', 'امضای دستور پرداخت'), ('SENT_TO_HQ', 'ارسال\u200cشده به HQ'), ('HQ_OPS_PENDING', 'در حال بررسی - بهره\u200cبرداری'), ('HQ_OPS_APPROVED', 'تأییدشده - بهره\u200cبرداری'), ('HQ_FIN_PENDING', 'در حال بررسی - مالی'), ('TEMP_APPROVED', 'تأیید موقت')], default='PENDING_APPROVAL', max_length=40, verbose_name='وضعیت')),
                ...
                ('locked_by_stage', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.accessrule', verbose_name='قفل شده توسط مرحله')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('DRAFT', 'پیش\u200cنویس'), ('PENDING', 'در حال بررسی'), ('APPROVE', 'تأیید شده'), ('REJECT', 'رد شده'), ('STAGE_CHANGE', 'تغییر مرحله'), ('DELETE', 'حذف'), ('CREATE', 'ایجاد'), ('EDIT', 'ویرایش'), ('VIEW', 'مشاهده'), ('PAID', 'پرداخت شده'), ('PARTIAL', 'تأیید جزئی'), ('PENDING_APPROVAL', 'در انتظار تأیید'), ('APPROVED_INTERMEDIATE', 'تأیید میانی'), ('APPROVED_FINAL', 'تأیید نهایی'), ('SIGN_PAYMENT', 'امضای دستور پرداخت'), ('SENT_TO_HQ', 'ارسال\u200cشده به HQ'), ('HQ_OPS_PENDING', 'در حال بررسی - بهره\u200cبرداری'), ('HQ_OPS_APPROVED', 'تأییدشده - بهره\u200cبرداری'), ('HQ_FIN_PENDING', 'در حال بررسی - مالی'), ('TEMP_APPROVED', 'تأیید موقت')], default='PENDING', max_length=40, verbose_name='وضعیت')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(choices=[('DRAFT', 'پیش\u200cنویس'), ('PENDING', 'در حال بررسی'), ('APPROVE', 'تأیید شده'), ('REJECT', 'رد شده'), ('STAGE_CHANGE', 'تغییر مرحله'), ('DELETE', 'حذف'), ('CREATE', 'ایجاد'), ('EDIT', 'ویرایش'), ('VIEW', 'مشاهده'), ('PAID', 'پرداخت شده'), ('PARTIAL', 'تأیید جزئی'), ('PENDING_APPROVAL', 'در انتظار تأیید'), ('APPROVED_INTERMEDIATE', 'تأیید میانی'), ('APPROVED_FINAL', 'تأیید نهایی'), ('SIGN_PAYMENT', 'امضای دستور پرداخت'), ('SENT_TO_HQ', 'ارسال\u200cشده به HQ'), ('HQ_OPS_PENDING', 'در حال بررسی - بهره\u200cبرداری'), ('HQ_OPS_APPROVED', 'تأییدشده - بهره\u200cبرداری'), ('HQ_FIN_PENDING', 'در حال بررسی - مالی'), ('TEMP_APPROVED', 'تأیید موقت')], max_length=45, verbose_name='نوع اقدام')),
                ...
                ('stage', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='approval_logs_access', to='core.accessrule', verbose_name='مرحله')),
        ...
        migrations.AddIndex(
            model_name='factor',
            index=models.Index(fields=['number', 'is_deleted', 'date', 'status', 'tankhah'], name='tankhah_fac_number_329775_idx'),
        ),
        migrations.AddIndex(
            model_name='approvallog',
            index=models.Index(fields=['factor', 'tankhah', 'user', 'stage', 'action'], name='tankhah_app_factor__35d1e3_idx'),
        ),
    ]

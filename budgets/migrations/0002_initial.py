...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='paymentorder',
            name='current_stage',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='payment_orders', to='core.accessrule', verbose_name='مرحله فعلی'),
        ),
        migrations.AddField(
            model_name='paymentorder',
            name='organization',

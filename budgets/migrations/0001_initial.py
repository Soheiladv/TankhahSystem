# Generated by Django 5.1.7 on 2025-04-12 19:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(choices=[('CREATE', 'ایجاد'), ('UPDATE', 'بروزرسانی'), ('STOP', 'توقف'), ('REALLOCATE', 'انتقال')], max_length=50)),
                ('amount', models.DecimalField(decimal_places=2, max_digits=25, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('details', models.TextField(blank=True)),
                ('transaction_type', models.CharField(choices=[('ALLOCATION', 'تخصیص'), ('CONSUMPTION', 'مصرف')], max_length=20, verbose_name='نوع تراکنش')),
            ],
        ),
        migrations.CreateModel(
            name='BudgetPeriod',
            fields=[
                ...
                ('locked_percentage', models.DecimalField(decimal_places=2, default=0, help_text='درصد بودجه که قفل می\u200cشود (0-100)', max_digits=5, verbose_name='درصد قفل\u200cشده')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allocation_type', models.CharField(choices=[('amount', 'مبلغ ثابت'), ('percent', 'درصد')], default='amount', max_length=20, verbose_name='نوع تخصیص')),
            ...
            options={
                ...
                'permissions': [('budgetallocation_add', 'افزودن تخصیص بودجه'), ('budgetallocation_view', 'نمایش تخصیص بودجه'), ('budgetallocation_update', 'بروزرسانی تخصیص بودجه'), ('budgetallocation_delete', 'حذف تخصیص بودجه'), ('budgetallocation_adjust', 'تنظیم تخصیص بودجه (افزایش/کاهش)'), ('budgetallocation_stop', 'توقف تخصیص بودجه')],
                'default_permissions': (),
            },
        ),
    ]

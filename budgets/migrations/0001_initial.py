    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('APPROVE', 'تأیید'), ('REJECT', 'رد'), ('SUBMIT', 'ارسال برای تایید'), ('FINAL_APPROVE', 'تایید نهایی'), ('VIEW', 'مشاهده'), ('EDIT', 'ویرایش'), ('CREATE', 'ایجاد'), ('DELETE', 'حذف'), ('SIGN_PAYMENT', 'امضای دستور پرداخت')], default='DRAFT', max_length=50, verbose_name='وضعیت')),

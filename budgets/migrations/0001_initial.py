    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tankhah_used_statuses', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(choices=[('DRAFT', 'پیش\u200cنویس'), ('PENDING', 'در انتظار تأیید'), ('APPROVED', 'تأیید شده'), ('REJECTED', 'رد شده'), ('PAID', 'پرداخت شده')], max_length=20), default=['PAID', 'APPROVED'], size=None, verbose_name='وضعیت\u200cهای مصرف\u200cشده تنخواه')),
            ],
            options={

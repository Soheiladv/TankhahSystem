    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': [('budgetperiod_add', 'افزودن دوره بودجه'), ('budgetperiod_update', 'بروزرسانی دوره بودجه'), ('budgetperiod_view', 'نمایش دوره بودجه'), ('budgetperiod_delete', 'حذف دوره بودجه'), ('budgetperiod_archive', 'بایگانی دوره بودجه'), ('budgetperiod_reports', 'بایگانی دوره بودجه')],
                'default_permissions': (),
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('transaction_type', models.CharField(choices=[('ALLOCATION', 'تخصیص اولیه'), ('CONSUMPTION', 'مصرف / هزینه'), ('COMMITMENT', 'تعهد / رزرو بودجه'), ('ADJUSTMENT_INCREASE', 'افزایش تخصیص'), ('ADJUSTMENT_DECREASE', 'کاهش تخصیص'), ('RETURN', 'برگشت به بودجه')], max_length=20, verbose_name='نوع تراکنش')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_number', models.CharField(blank=True, max_length=20, null=True, validators=[django.core.validators.RegexValidator(message='شماره حساب باید 5-20 رقم باشد.', regex='^\\d{5,20}$')], verbose_name='شماره حساب')),
                ('iban', models.CharField(blank=True, max_length=34, null=True, validators=[django.core.validators.RegexValidator(message='شبا باید IR + 24 رقم باشد.', regex='^IR[0-9]{2}[0-9]{22}$')], verbose_name='شبا')),
                ('address', models.TextField(blank=True, null=True, verbose_name='آدرس')),
                ('phone', models.CharField(blank=True, max_length=11, null=True, validators=[django.core.validators.RegexValidator(message='تلفن باید 09xxxxxxxxx باشد.', regex='^09[0-9]{9}$')], verbose_name='تلفن')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='فعال')),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='transaction_types_created', to=settings.AUTH_USER_MODEL, verbose_name='ایجادکننده')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archived_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='archived_payment_orders', to=settings.AUTH_USER_MODEL, verbose_name='آرشیو شده توسط')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='created_payment_orders', to=settings.AUTH_USER_MODEL, verbose_name='ایجادکننده')),
            ],
            options={
